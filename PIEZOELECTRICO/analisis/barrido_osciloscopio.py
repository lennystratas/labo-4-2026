...
# frecuencias_grueso = np.logspace(2, 6, 40)
# frecuencias_fino = np.linspace(3500, 7500, 30)
# frecuencias = np.sort(np.concatenate([frecuencias_fino, frecuencias_grueso]))
# frecuencias = frecuencias[frecuencias > 5983]
frecuencias = np.linspace(5.02e4, 5.04e4, 60)
...
df.to_csv(save_folder+"barrido_osciloscopio_fino_3v2.csv", index=False, header=True)
#%%
