...
phi_aj_c = lambda f, R, L, C, C2, phi_0: fase_C2(f, R, L, C, C2, R2, phi_0)
p0 = (Rs, Ls, Cs, 2.3e-12)
...
ax2.legend(loc=(0.29, 0.22))
fig.tight_layout()
fig.savefig(image_folder + "grafico_barrido_m1.pdf", bbox_inches="tight")
